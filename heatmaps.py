...
#thresholds: out of this range sigma collapses and the gof pathologically ignore variations in G
thx=(-0.08,0.2);thy =(-0.2,0.08) 

def extract(filepath,xv="delta_G",yv="delta_sigma",var2see="euccorr",C1=0,w=1,thx=thx,thy =thy):
...
filename_map = "output/sweep_deltamaps_from_homoW_fromG0.16_sigma7.68_maps_1_1_9dic24_50iter.txt"
filename_shuf = "output/sweep_deltaSHUFFLED_from_homoW_fromG0.16_sigma7.68_maps_2_2_9dic24_50iter.txt"
...
# poss = (1,2,4,5)
################################HERE WE FIND THE OPTIMALS AND GENERATE THE FIG SF1
